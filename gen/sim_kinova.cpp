...
int main()
{
  ...
  double init_angles[7] = {0.0, 0.26, 0.0, 2.26, 0.0, -0.95, -1.57};

  // double init_angles[7] = {87.41, 36.59, 19.76, 225.92, 12.65, 60.62, 90.0};
  // for (size_t i = 0; i < 7; i++)
  // {
  //   init_angles[i] = DEG2RAD(init_angles[i]);
  // }

  // double init_angles[7] = {4.22392, 0.183554, 3.6852, -2.02838, 2.95626, -1.55941, 3.23753};
  ...
  double achd_solver_kinova_right_nc = 6;
  double achd_solver_kinova_left_root_acceleration[6] = {0, 0., -9.8, 0.0, 0.0, 0.0};
  ...
  while (count < 1)
  {
    ...
    achd_solver_manipulator(&kinova_left, achd_solver_kinova_right_nc,
    ...
    printf("rne left output torques: ");
    for (size_t i = 0; i < 7; i++)
    {
      std::cout << achd_solver_kinova_left_output_torques[i] << " ";
    }
