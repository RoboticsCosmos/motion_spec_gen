...
int main()
{
  ...
  std::cout << "robile_base_to_left_arm_base: " << base_to_left_base.p(0) << " " << base_to_left_base.p(1) << " " << base_to_left_base.p(2) << std::endl;


  KDL::Frame left_base_to_base = base_to_left_base.Inverse();

  std::cout << "left_arm_base_to_robile_base: " << left_base_to_base.p(0) << " " << left_base_to_base.p(1) << " " << left_base_to_base.p(2) << std::endl;
