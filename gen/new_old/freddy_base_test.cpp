...
int main()
{
  ...
  while (true)
  {
    ...
    // solver
    double platform_force[3] = { 0.0, 0.0, 200.0};  // [N], [N], [Nm]
    ...
    KDL::Wrench f1 = ((frame1 * Fpiv_rb) - Fplt);
    KDL::Wrench f2 = ((frame2 * Fpiv_rb) - Fplt);
    KDL::Wrench f3 = ((frame3 * Fpiv_rb) - Fplt);
    KDL::Wrench f4 = ((frame4 * Fpiv_rb) - Fplt);
