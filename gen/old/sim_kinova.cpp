...
int main()
{
  ...
  double init_angles_left[7] = {1.97791, -0.219453, 6.07101, -2.09586, 3.03115, -1.47373, 3.07873};
  ...
  while (count < 2500)
  {
    ...
    init_2d_array(achd_solver_kinova_right_alpha_transf, 6, 6);
    transform_alpha(&robot, base_link, kinova_right.base_frame, achd_solver_kinova_right_alpha,
                    achd_solver_kinova_nc, achd_solver_kinova_right_alpha_transf);
    achd_solver(&robot, kinova_right.base_frame, kinova_right.tool_frame, achd_solver_kinova_nc,
